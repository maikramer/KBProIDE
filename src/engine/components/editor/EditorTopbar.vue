<template>
  <div class="editor-topbar">
    ...
    <div class="right">
      ...
      <button class="btn" @click="openBoardManager" title="Gerenciador de Placas">
        <i class="fa fa-microchip"></i>
      </button>
      <button class="btn" @click="toggleKids" :title="$global.setting.kidsMode ? 'Sair do modo Kids' : 'Entrar no modo Kids'">
        <i class="fa fa-child"></i>
      </button>
      <button class="btn" @click="openEditorSettings" title="Configurações do Editor">
...
export default {
  ...
  methods: {
    openBoardManager(){ try { this.$global.$emit && this.$global.$emit('open-board-dialog'); } catch(e){} },
    toggleKids(){ try { this.$global.setting.kidsMode = !this.$global.setting.kidsMode; this.$global.$emit && this.$global.$emit('kids-mode-change', this.$global.setting.kidsMode); } catch(e){} },
    openEditorSettings(){
      try {
        // AsyncComponent resolve caminho relativo a src/engine/AsyncComponent.vue
